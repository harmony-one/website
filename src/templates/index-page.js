...
export const IndexPageTemplate = ({
  ...
  <div className="hero hero__home">
      ...
      <ul className="social-icons">
          <li key="medium">
              <a href="/blog/" className="social__item" data-g-event="footer" data-g-label="medium" data-g-action="clicked">
                  <span>
          ...
          <li key="discord">
              <a href="https://discordapp.com/invite/rdCmBpe" className="social__item" data-g-event="footer" data-g-label="discord" data-g-action="clicked">
                  <span>
          ...
          <li key="instagram">
              <a href="https://www.instagram.com/harmonyoneprotocol/" className="social__item" target="" data-g-event="footer" data-g-label="instagram" data-g-action="clicked">
                  <span>
          ...
          <li key="telegram">
              <a href="https://t.me/harmony_one" className="social__item" target="" data-g-event="footer" data-g-label="telegram" data-g-action="clicked">
                  <span>
          ...
          <li key="twitter">
              <a href="https://twitter.com/harmonyprotocol" className="social__item" target="" data-g-event="footer" data-g-label="linkedin" data-g-action="clicked">
                  <span>
          ...
          <li key="linkedin">
              <a href="https://www.linkedin.com/company/harmony-protocol/" className="social__item" target="" data-g-event="footer" data-g-label="linkedin" data-g-action="clicked">
                  <span>
  ...
  <section className="decentralization">
      ...
      <div className="container decentralization__container">
          <div className="decentralization__text text-container">
              <h3 className="text-container__title desktop">{decentralization.heading}</h3> {decentralization.description.map((item, index) => (
