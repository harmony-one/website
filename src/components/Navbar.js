      ...
      return (
        ...
        <div className="header__side-menu__logo--container">
          <div className="header__logo header__side-menu__logo">
            <a href="/" className="header__logo" data-g-event="header" data-g-label="Logo" data-g-action="clicked">
              <span>
        ...
        <ul className="header__nav-items mobile"><li id="header-nav__items__item" className="hide-md">
            <a href="/technology/" className="header__nav-item">
              <span>Technology</span>
            </a>
          </li><li id="header-nav__items__item" className="hide-md">
          ...
          </li><li id="header-nav__items__item" className="whitepaper-button">
      ...
      <header className={this.state.headerClass + this.state.is_open} >
        <nav className="header__nav">
          ...
          <ul className="header__nav-items desktop">
            ...
            </li><li id="nav-item__team" className={"hide-md " + this.state.team}>
              <a href="/team/" className="header__nav-item">
                <span>Team</span>
              </a>
            </li><li id="nav-item__careers" className={"hide-md " + this.state.careers}>
              <a href="/careers/" className="header__nav-item">
                <span>Careers</span>
              </a>
            </li><li id="nav-item__partners" className={"hide-md " + this.state.partners}>
              <a href="/partners/" className="header__nav-item">
                <span>Partners</span>
              </a>
            </li><li id="nav-item__blog" className={"hide-md " + this.state.blog}>

              <a href="/blog/" className="header__nav-item">
                <span>Blog</span>
              </a>
            </li><li id="nav-item__blog" className="hide-md">
